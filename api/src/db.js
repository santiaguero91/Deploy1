...
const sequelize = new Sequelize(
  ...
  DB_DEPLOY,
  {
    ...
    dialectOptions: {
      ssl: {
        require: true,
        rejectUnauthorized: false // Esta propiedad es necesaria si estás usando SSL con un certificado autofirmado
      }
    }
  }
);
...
const { Producto, Usuario, Categoria, Reviews } = sequelize.models;
